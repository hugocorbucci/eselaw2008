...
following work. The most controversial definition is the open source
one while agile methods are more simply defined.
...
the wider Lean philosophy \cite{Poppendieck2003}.
...
% Falar da diferença entre liderança numa empresa e numa comunidade
...
to start this sort of merging to stun the werewolf, i.e., stop
problems from appearing unexpectedly.
...
Not only, as previously shown, agile methodologies lack some special
solutions related to open source development, but they could also
benefit from solving some of the issues FOSS project suffer
from. Section \ref{subsec:agile-lacks} will describe with more details
some specific points of FOSS development that would need a specific
approach. The next one (Section \ref{subsec:agile-self-improv}) will
...
\item If so, how to estimate expectations about outside contributions?
