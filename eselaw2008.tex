...
while the most controversial definition, the open source one, is given
at Section \ref{subsec:os-def}.
...
their own personal growth. This reasons explain why open source
...
correcting them before they get implemented or inserted in the main
code base.

Obviously such practice can only apply to some level when the user is
not a developer. Having an external review will always help ensuring
API clarity and document the changes but it might not detect
requirement problems if the reviewer is not a user or client.

% Talvez falar sobre review collectivo de patches em bug tracks
